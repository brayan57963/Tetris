...
class Game {
    ...
    static EMPTY_COLOR = "#000"
    static BORDER_COLOR = "#13ca91";
    ...
    showWelcome() {
        Swal.fire("Bienvenido", `Port casi perfecto del juego de Tetris en JavaScript modificado por brayan correa.
<br>
